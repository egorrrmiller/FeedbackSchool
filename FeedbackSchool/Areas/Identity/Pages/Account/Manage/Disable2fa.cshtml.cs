...
public class Disable2faModel : PageModel
{
    ...
    public Disable2faModel(UserManager<FeedbackSchoolUser> userManager,
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        StatusMessage =
            "2FA был отключен. Вы можете включить 2FA, когда вы настроите приложение для проверки подлинности";
