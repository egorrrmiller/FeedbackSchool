...
public class ExternalLoginsModel : PageModel
{
    ...
    public ExternalLoginsModel(UserManager<FeedbackSchoolUser> userManager,
    ...
    public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
    {
        ...
        {
            StatusMessage =
                "Внешний логин не был добавлен. Внешние логины могут быть связаны только с одной учетной записью.";
