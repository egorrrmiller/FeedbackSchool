...
namespace FeedbackSchool.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(7, ErrorMessage = "Длина кода подтверждения должна быть не менее {2} и не более {1} символов.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Ваш аутентификатор был проверен.";
